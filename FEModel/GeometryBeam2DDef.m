classdef GeometryBeam2DDef < ComponentDef
    properties
    ...
    methods
        function obj = GeometryBeam2DDef(fcn_geometry, beam_props, number_of_elements)
        ...
        function [obj, U, FEModel_index_nodes] = mesh(obj, FEModel_index_nodes)
            ...
            for i = 1:obj.number_of_elements
                for j = 1:(obj.number_of_nodes_per_beam-2)
                    ...
                    f_j = obj.fcn_geometry(-1.0 + 2 * alpha, 2);
                ...
                if i == obj.number_of_elements
                    frame_tip = obj.fcn_geometry(1.0, 2);
                    list_R0{end} = frame_tip(1:2);
                    if isnumeric(obj.n_tip) && obj.n_tip == -1
                        U(end-1:end) = frame_tip(3:4);
                    ...
                    f_i = obj.fcn_geometry(-1 + 2 * alpha, 2);

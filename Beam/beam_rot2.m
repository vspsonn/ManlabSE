...
neq_aux = n_elem * n_gp * (4 * n_nodes + 4); % Number of auxiliary variables used

writing = 'standard'; % Writing of the system {'standard' or 'vectorial'}

% Parameters specific to your system
parameters.K = 83.34e4 * eye(3);
parameters.n_gp = n_gp;

%% initialization of the system - Should not be changed
sys=SystAQ(neq,neq_aux,@equations_rot2,@point_display,@global_display,parameters,writing);
